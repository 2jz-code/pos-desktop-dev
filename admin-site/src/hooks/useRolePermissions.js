...
export const useRolePermissions = () => {
	...
	const canAccessInventory = () => isOwner || isManager;
	...
	const canViewInventory = () => isOwner || isManager;
	const canEditInventory = () => isOwner || isManager;
	const canAdjustStock = () => isOwner || isManager;
	const canTransferStock = () => isOwner || isManager;

	// Reporting permissions
	const canViewSalesReports = () => isOwner || isManager;
	const canViewInventoryReports = () => isOwner || isManager;
	const canViewUserReports = () => isOwner || isManager;
	const canViewPaymentReports = () => isOwner || isManager;
	const canExportReports = () => isOwner || isManager;

	// Audit permissions
	const canViewAuditLogs = () => isOwner || isManager;
	const canViewSystemLogs = () => isOwner;
	const canViewUserActivity = () => isOwner || isManager;
