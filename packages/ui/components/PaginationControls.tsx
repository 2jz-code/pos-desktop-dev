/**
 * Shared PaginationControls Component
 *
 * Note: This component expects Button and Select components to be provided
 * by the consuming app, as each app has its own shadcn/ui setup.
 *
 * Usage:
 * import { Button } from "@/components/ui/button";
 * import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/components/ui/select";
 * import { PaginationControls } from "@ajeen/ui/components/PaginationControls";
 */

import React from "react";
import { ChevronLeft, ChevronRight } from "lucide-react";

interface PaginationControlsComponents {
