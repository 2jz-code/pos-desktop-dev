# Generated by Django 4.2.13 on 2025-12-12 04:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(help_text="Short code for the unit, e.g., 'g', 'kg', 'oz', 'lb', 'each'", max_length=20, unique=True)),
                ('name', models.CharField(help_text="Full name of the unit, e.g., 'gram', 'kilogram', 'ounce'", max_length=50)),
                ('category', models.CharField(choices=[('weight', 'Weight'), ('volume', 'Volume'), ('count', 'Count')], help_text='Category of the unit: weight, volume, or count', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.ForeignKey(help_text='The unit the cost is expressed in (e.g., cost per kg)', on_delete=django.db.models.deletion.PROTECT, related_name='cost_sources', to='cogs.unit')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('archived_at', models.DateTimeField(blank=True, help_text='Timestamp when this record was archived.', null=True)),
                ('archived_by', models.ForeignKey(blank=True, help_text='User who archived this record.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_archived', to=settings.AUTH_USER_MODEL)),
                ('base_unit', models.ForeignKey(help_text='The base unit for all COGS calculations for this ingredient', on_delete=django.db.models.deletion.PROTECT, related_name='ingredient_configs', to='cogs.unit')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('archived_by', models.ForeignKey(blank=True, help_text='User who archived this record.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_archived', to=settings.AUTH_USER_MODEL)),
                ('from_unit', models.ForeignKey(help_text='The source unit', on_delete=django.db.models.deletion.CASCADE, related_name='conversions_from', to='cogs.unit')),
                ...
                ('to_unit', models.ForeignKey(help_text='The target unit', on_delete=django.db.models.deletion.CASCADE, related_name='conversions_to', to='cogs.unit')),
            ],
            options={
                'verbose_name': 'Unit Conversion',
                'verbose_name_plural': 'Unit Conversions',
                'indexes': [models.Index(fields=['tenant', 'product'], name='cogs_unitco_tenant__b09711_idx'), models.Index(fields=['tenant', 'from_unit', 'to_unit'], name='cogs_unitco_tenant__aee0d1_idx')],
            },
        ),
        ...
        migrations.AddIndex(
            model_name='unit',
            index=models.Index(fields=['code'], name='cogs_unit_code_633a4e_idx'),
        ),
        migrations.AddIndex(
            model_name='unit',
            index=models.Index(fields=['category'], name='cogs_unit_categor_bec27e_idx'),
        ),
        migrations.AddIndex(
