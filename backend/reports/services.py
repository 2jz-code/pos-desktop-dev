...
from .services_new import PaymentsReportService
...
class ReportService:
    ...
    def generate_payments_report(
        ...
        """Generate payment methods report - delegates to PaymentsReportService"""
        return PaymentsReportService.generate_payments_report(start_date, end_date, use_cache)
    ...
    def _export_payments_to_csv(writer, report_data: Dict[str, Any]):
        """Export payments report to CSV - delegates to PaymentsReportService"""
