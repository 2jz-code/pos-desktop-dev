...
import ModifierSetLibrary from "@/domains/products/components/modifiers/ModifierSetLibrary";
...
const ModifierManagementPage = () => {
  ...
  const handleDeleteModifierSet = async (modifierSetId) => {
    if (!confirm('Are you sure you want to delete this modifier set?')) return;

    try {
      await modifierService.deleteModifierSet(modifierSetId);
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-1">
              Manage your modifier sets and options across all products
            </p>
          </div>
        </div>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {loading ? (
              ...
              <div className="col-span-full text-center py-12 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300">
                ...
                <h4 className="text-lg font-medium text-gray-900 mb-2">No modifier sets found</h4>
              ...
              filteredModifierSets.map((modifierSet) => (
                <Card key={modifierSet.id} className="hover:shadow-lg transition-shadow">
                  <CardHeader className="pb-2">
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <CardTitle className="text-lg">{modifierSet.name}</CardTitle>
                      ...
                      <div className="flex gap-1">
                        ...
                        <Button
                          variant="ghost"
                          size="sm"
                          onClick={() => handleDuplicateModifierSet(modifierSet)}
                        >
                        ...
                        <Button
                          variant="ghost"
                          size="sm"
                          onClick={() => handleDeleteModifierSet(modifierSet.id)}
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center gap-2">
                        ...
                        >
                          ...
                          {modifierSet.selection_type === 'MULTIPLE' ? 'Multi' : 'Single'}
                      ...
                      {modifierSet.options && modifierSet.options.length > 0 && (
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center py-12">
                ...
                <h4 className="text-lg font-medium text-gray-900 mb-2">Templates Coming Soon</h4>
                <p className="text-gray-500 max-w-sm mx-auto">
                  Pre-built modifier templates for common use cases like sizes, add-ons, and cooking preferences.
                </p>
              </div>
            </CardContent>
          </Card>
